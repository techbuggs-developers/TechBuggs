...
const PrivacyPolicy: React.FC = () => {
  return (
    <main className="bg-white text-[#014F86] pt-32 pb-20 px-4 md:px-16 max-w-7xl mx-auto">
      <h1 className="text-3xl md:text-4xl font-bold mb-6 text-center">
        Privacy Policy
      </h1>

      <article className="space-y-6 text-base leading-relaxed text-[#4A4A4A]">
        <p>
        ...
        <section>
          ...
          <p>
            ...
            <a href="mailto:Info@techbuggs.com" className="text-[#008080]">Info@techbuggs.com</a>.
          </p>
        </section>
      </article>
    </main>
