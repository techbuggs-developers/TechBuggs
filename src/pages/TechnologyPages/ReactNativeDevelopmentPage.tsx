...
import { Smartphone, Code2, Zap, Globe, Layers, Share2 } from "lucide-react";
          ...
          {[
            {
              ...
              text: "Write mobile apps using familiar JavaScript and TypeScript syntax.",
              delay: 0.1,
            },
            {
              icon: <Layers size={24} />,
              title: "Native Components",
              text: "Access native platform components and APIs for optimal performance.",
              delay: 0.2,
            },
            {
              icon: <Smartphone size={24} />,
              title: "Cross-Platform",
              text: "Develop for both iOS and Android with a single codebase.",
              delay: 0.3,
            },
            {
              icon: <Zap size={24} />,
              title: "Hot Reloading",
              text: "See your changes instantly with fast refresh and hot reloading.",
              delay: 0.4,
            },
            {
              icon: <Share2 size={24} />,
              title: "Third-Party Libraries",
              text: "Access a vast ecosystem of pre-built components and libraries.",
              delay: 0.5,
            },
            {
              icon: <Globe size={24} />,
              title: "App Store Ready",
              text: "Deploy your apps to the App Store and Google Play Store.",
              delay: 0.6,
            },
          ].map((item, i) => (
            <motion.div
